      ...
      <div className="lg:p-10 p-1 container mx-auto relative">
        <section className="transition duration-500 ease-in-out transform hover:scale-105 bg-white rounded-lg shadow-2xl lg:flex p-5">
          ...
          <div className="lg:p-16">
            <div className="lg:text-7xl text-5xl text-blue-800 lg:content-center lg:items-center text-center">
              <h2>Hey there!</h2>
            </div>
            ...
            <div className="lg:content-center lg:items-center text-center">
              ...
              <hr style={{ borderTop: "solid black 1px" }} className="m-5" />
              <p className="lg:text-5xl text-3xl text-blue-800">
        ...
        <section className="transition duration-500 ease-in-out transform hover:scale-105 bg-white rounded-lg shadow-2xl lg:flex p-5 mt-10">
          <div className="lg:p-20">
            <div className="text-5xl text-blue-800 lg:content-center lg:items-center lg:text-left text-center">
        ...
        <section className="transition duration-500 ease-in-out transform hover:scale-105 bg-white rounded-lg shadow-2xl lg:flex p-5 mt-10">
          <div className="lg:p-20">
            <h1 className="lg:text-7xl text-4xl text-blue-800 content-center items-center text-center justify-center">
