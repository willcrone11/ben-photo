      ...
      <div className="p-10 container mx-auto relative">
        <section className="transition duration-500 ease-in-out transform hover:scale-105 bg-white rounded-lg shadow-2xl lg:flex p-5">
          ...
          <div className="lg:p-32">
            <div className="lg:text-6xl text-5xl text-blue-800 lg:content-center lg:items-center text-center">
              <h2>Hey there!</h2>
            </div>
        ...
        <section className="transition duration-500 ease-in-out transform hover:scale-105 bg-white rounded-lg shadow-2xl lg:flex p-5 mt-10">
          <div className="lg:p-20">
            <div className="text-4xl text-blue-800 lg:content-center lg:items-center lg:text-left text-center">
              <h2>For the wild lovers, wildly in love.</h2>
            </div>
            <hr style={{ borderTop: "solid black 1px" }} className="m-5" />
            <div className="lg:content-center lg:items-center lg:text-left text-center">
              <p className="text-xl">
        ...
        <section className="transition duration-500 ease-in-out transform hover:scale-105 bg-white rounded-lg shadow-2xl lg:flex p-5 mt-10">
          <div className="lg:p-20">
            <h1 className="lg:text-6xl text-2xl text-blue-800 content-center items-center text-center justify-center">
        ...
        <div className="lg:m-32 m-14">
          <p className="lg:text-5xl text-2xl content-center items-center text-center">
